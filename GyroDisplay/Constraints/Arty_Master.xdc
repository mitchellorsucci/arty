...
##RGB LEDs
##                                                                     2   1   0
## The RGBLeds are wired as a 3-wire bus Blue as LSB and Red as MSB -- R / G / B
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { PWM0B }]; #IO_L18N_T2_35 Sch=RGBLED0[0]
set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { PWM0G }]; #IO_L19N_T3_VREF_35 Sch=RGBLED0[1]
set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { PWM0R }]; #IO_L19P_T3_35 Sch=RGBLED0[2]
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports { PWM1B }]; #IO_L20P_T3_35 Sch=RGBLED1[0]
set_property -dict { PACKAGE_PIN J4    IOSTANDARD LVCMOS33 } [get_ports { PWM1G }]; #IO_L21P_T3_DQS_35 Sch=RGBLED1[1]
set_property -dict { PACKAGE_PIN G3    IOSTANDARD LVCMOS33 } [get_ports { PWM1R }]; #IO_L20N_T3_35 Sch=RGBLED1[2]
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { PWM2B }]; #IO_L21N_T3_DQS_35 Sch=RGBLED2[0]
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports { PWM2G }]; #IO_L22N_T3_35 Sch=RGBLED2[1]
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { PWM2R }]; #IO_L22P_T3_35 Sch=RGBLED2[2]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { PWM3B }]; #IO_L23P_T3_35 Sch=RGBLED3[0]
set_property -dict { PACKAGE_PIN H6    IOSTANDARD LVCMOS33 } [get_ports { PWM3G }]; #IO_L24P_T3_35 Sch=RGBLED3[1]
set_property -dict { PACKAGE_PIN K1    IOSTANDARD LVCMOS33 } [get_ports { PWM3R }]; #IO_L23N_T3_35 Sch=RGBLED3[2]
...
set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[0] }]; #IO_0_15 Sch=ja[1]
set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[1] }]; #IO_L4P_T0_15 Sch=ja[2]
set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[2] }]; #IO_L4N_T0_15 Sch=ja[3]
set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[3] }]; #IO_L6P_T0_15 Sch=ja[4]
set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[4] }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[5] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[6] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { LCD_DATA[7] }]; #IO_25_15 Sch=ja[10]
...
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { LCD_CONTROL[0] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { LCD_CONTROL[1] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { LCD_CONTROL[2] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
